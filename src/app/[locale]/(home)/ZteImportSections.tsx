...
export default async function ZteImportSections({ locale }: { locale: string }){
  const cats = await loadZte();
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="flex items-center justify-between mb-4"><h2 className="text-xl font-semibold">ZTE Ürünleri</h2></div>
