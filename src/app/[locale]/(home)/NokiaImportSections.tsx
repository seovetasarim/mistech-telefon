...
export default async function NokiaImportSections({ locale }: { locale: string }){
  const cats = await loadNokia();
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="flex items-center justify-between mb-4"><h2 className="text-xl font-semibold">Nokia Ürünleri</h2></div>
