...
export default async function AsusImportSections({ locale }: { locale: string }){
  const cats = await loadAsus();
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="flex items-center justify-between mb-4"><h2 className="text-xl font-semibold">ASUS Ürünleri</h2></div>
