...
export default async function OneplusImportSections({ locale }: { locale: string }){
  const cats = await loadOneplus();
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="flex items-center justify-between mb-4"><h2 className="text-xl font-semibold">OnePlus Ürünleri</h2></div>
