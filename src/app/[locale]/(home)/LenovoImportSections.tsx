...
export default async function LenovoImportSections({ locale }: { locale: string }){
  const cats = await loadLenovo();
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="flex items-center justify-between mb-4"><h2 className="text-xl font-semibold">Lenovo Ürünleri</h2></div>
